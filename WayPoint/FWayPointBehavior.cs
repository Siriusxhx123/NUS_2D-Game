...
public partial class FWayPointBehavior : MonoBehaviour 
{
    ...
    private void FThisWayPointIsHit()
    {
        

        mWayPointTemplate = Resources.Load<GameObject>("Prefabs/F");

        // 确保生成边界有效
        mSpawnRegionMin = new Vector2(-45, -15);
        mSpawnRegionMax = new Vector2(-15, 15);
    ...
    private void FGenerateWayPoint()
    { 
